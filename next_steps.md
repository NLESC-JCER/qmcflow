...
git branch -M main
git remote add origin git@github.com:NLESC-JCER/qmcflow
```

## Push the initial commit to a new repo on GitHub

Go to
[https://github.com/organizations/NLESC-JCER/repositories/new](https://github.com/organizations/NLESC-JCER/repositories/new)
and create a new repository named `qmcflow` as an empty repository, then push your commits to GitHub:
...
automatically ([here](git@github.com:NLESC-JCER/qmcflow/issues?q=author%3Aapp%2Fgithub-actions)). Resolve them to complete the
